-- 完整的函数修复脚本：解决函数名不唯一和JSON语法错误问题

-- 第一步：删除所有版本的assign_training_program_to_student函数
...
-- 第二步：删除所有版本的batch_assign_training_program_to_teacher_students函数
...
-- 第三步：重新创建正确的assign_training_program_to_student函数
...
-- 第四步：重新创建正确的batch_assign_training_program_to_teacher_students函数
